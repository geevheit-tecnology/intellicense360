...
func NewMemoryStore() *MemoryStore {
	...
	perms := []domain.Permission{
		...
		{ID: "perm-intelligence-manage", Key: "intelligence.intelligence.manage", Description: "Manage intelligence engine", CreatedAt: now},
		{ID: "perm-intelligence-read", Key: "intelligence.intelligence.read", Description: "Read intelligence engine", CreatedAt: now},
		...
		{ID: "perm-mission-control-read", Key: "mission_control.read", Description: "Read mission control", CreatedAt: now},
		{ID: "perm-mission-control-create", Key: "mission_control.create", Description: "Create mission control items", CreatedAt: now},
		{ID: "perm-mission-control-update", Key: "mission_control.update", Description: "Update mission control items", CreatedAt: now},
		{ID: "perm-mission-control-acknowledge", Key: "mission_control.acknowledge", Description: "Acknowledge mission control items", CreatedAt: now},
		{ID: "perm-mission-control-resolve", Key: "mission_control.resolve", Description: "Resolve mission control items", CreatedAt: now},
		{ID: "perm-mission-control-dismiss", Key: "mission_control.dismiss", Description: "Dismiss mission control items", CreatedAt: now},
		{ID: "perm-mission-control-snapshot", Key: "mission_control.snapshot", Description: "Rebuild mission control snapshots", CreatedAt: now},
		{ID: "perm-mission-control-admin", Key: "mission_control.admin", Description: "Administer mission control", CreatedAt: now},
