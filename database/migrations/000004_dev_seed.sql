...
values
    ...
    ('intelligence.intelligence.manage', 'Manage intelligence engine'),
    ('intelligence.intelligence.read', 'Read intelligence engine'),
    ('inventory.inventory.manage', 'Manage inventory'),
    ('maintenance.maintenance.manage', 'Manage maintenance'),
    ('mission_control.read', 'Read mission control'),
    ('mission_control.create', 'Create mission control items'),
    ('mission_control.update', 'Update mission control items'),
    ('mission_control.acknowledge', 'Acknowledge mission control items'),
    ('mission_control.resolve', 'Resolve mission control items'),
    ('mission_control.dismiss', 'Dismiss mission control items'),
    ('mission_control.snapshot', 'Rebuild mission control snapshots'),
    ('mission_control.admin', 'Administer mission control'),
